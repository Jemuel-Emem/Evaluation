    ...
    <style>
        ...
        .nav-bg {
            background: linear-gradient(
                ...
                url('{{ asset('images/bg_sksu.jpg') }}') no-repeat center center;
    ...
    <div class="flex h-screen overflow-hidden bg-white">
        ...
        <div class="hidden md:flex md:flex-shrink-0">
            <div class="flex flex-col w-64">
                <div class="flex flex-col flex-grow pt-5 overflow-y-auto nav-bg border-r">
                    <div class="flex flex-col flex-shrink-0 px-4">
                        <a class="inline-flex items-center gap-3 text-xl font-bold tracking-tight text-black" href="/">
                            <span>
                                <img src="{{ asset('images/logo.jpg') }}" alt="" class="w-8 h-8 border-collapse rounded-xl">
                            </span>
                                    ...
                                    <div x-data="{ open: false }">
                                        ...
                                        <div class="p-2 pl-6 -px-px" x-show="open" @click.outside="open = false" style="display: none;">
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="{{ route('survey_questions') }}" title="#" class="inline-flex items-center w-full p-2 pl-3 text-sm font-light text-gray-500 rounded-lg group hover:bg-green-700">
                                                        <span class="inline-flex items-center w-full">
                                                            <ion-icon class="size-4 md hydrated" name="document-outline" role="img" aria-label="document outline"></ion-icon>
                                                            <span class="ml-4 text-white"> Manage Questions</span>
                                                        </span>
                                                    </a>
                                                </li>

                                                <li>
                                                    <a href="{{ route('evaluation') }}" title="#" class="inline-flex items-center w-full p-2 pl-3 text-sm font-light text-gray-500 rounded-lg group hover:bg-green-700">
                                                        <span class="inline-flex items-center w-full">
                                                            <ion-icon class="size-4 md hydrated" name="document-outline" role="img" aria-label="document outline"></ion-icon>
                                                            <span class="ml-4 text-white"> Evaluation</span>
                                                        </span>
                                                    </a>
                                                </li>
                        ...
                        <div @click.away="open = false" class="relative inline-flex items-center w-full" x-data="{ open: false }">
                            <button @click="open = !open"
                                ...
                                <svg :class="{'rotate-180': open, 'rotate-0': !open}" xmlns="http://www.w3.org/2000/svg"
                                    class="inline size-5 ml-4 text-black transition-transform duration-200 transform rotate-0" viewBox="0 0 20 20"
                                    fill="currentColor">
                                    ...
                                    <ul>
                                        <li>
                                            <a class="inline-flex items-center w-full px-4 py-2 mt-1 text-sm text-gray-500 transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100 hover:scale-95 hover:text-blue-500"
                                                href="{{ route('logout') }}">
                                                <ion-icon class="size-4 md hydrated" name="body-outline" role="img"
            ...
            <main class="relative flex-1 overflow-y-auto focus:outline-none">
                <div class="py-6">
                    <div class="px-4 mx-auto 2xl:max-w-7xl sm:px-6 md:px-8">
                        <div class="py-4">
                            <div class="h-screen  border-gray-200 rounded-lg">
                                <main>
                                    {{ $slot }}
                                </main>
                            </div>

    ...
    <x-modal wire:model.defer="add_modal">
        <x-card title="Create Evaluation">
            <div class="space-y-4">
                ...
                <x-checkbox label="Select Program Activity"
                wire:model="selectedQuestions.program_activity"
                :value="$programActivities->first()?->id" />

            <x-checkbox label="Include Venue"
                wire:model="selectedQuestions.venue"
                :value="$venues->first()?->id" />

            <x-checkbox label="Include Accommodation"
                wire:model="selectedQuestions.accommodation"
                :value="$accommodations->first()?->id" />

            <x-checkbox label="Include Speaker"
                wire:model="selectedQuestions.speaker"
                :value="$speakers->first()?->id" />
    ...
    <x-modal wire:model.defer="edit_modal">
        <x-card title="Edit Evaluation">
            <div class="space-y-4">
                ...
                <x-checkbox label="Select Program Activity" wire:model="selectedQuestions.program_activity" value="1" />
                <x-checkbox label="Select Venue" wire:model="selectedQuestions.venue" value="2" />
                <x-checkbox label="Select Accommodation" wire:model="selectedQuestions.accommodation" value="3" />

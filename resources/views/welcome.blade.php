...
<body>
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 sm:p-12 text-center" x-data="{ show: false }" x-init="setTimeout(() => show = true, 500)">
            <h1 class="text-4xl font-bold text-gray-100 transition-transform duration-700 transform" x-bind:class="show ? 'translate-y-0' : '-translate-y-10'">
                Evaluation Management System
            </h1>
            <p class="mt-4 text-lg text-gray-200 opacity-0 transition-opacity duration-700 delay-300" x-bind:class="show ? 'opacity-100' : 'opacity-0'">
            ...
            <p class="mt-6 text-lg text-gray-200 opacity-0 transition-opacity duration-1000 delay-700" x-bind:class="show ? 'opacity-100' : 'opacity-0'">
